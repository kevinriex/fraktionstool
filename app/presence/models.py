...
class Function(models.Model):
	...
	fee = models.DecimalField(max_digits=8, decimal_places=2, help_text="Abgabe in Euro", verbose_name="Abgabe")
...
class Appointment(models.Model):
	...
	location = models.ForeignKey(Location, on_delete=models.SET_NULL, null=True, verbose_name="Ort")
	date = models.DateTimeField(verbose_name="Datum")
	attendees = models.ManyToManyField(Person, related_name="appointments", verbose_name="Anwesende")
